...
module.exports = {
  ...
  CLUSTER_KUBESPHERE_SETTINGS_DESC: 'Customized settings for Petasus Kubernetes',
  ...
  NODE_INTERNAL_IP_DESC: 'Set the internal IP address of the node in the Petasus Kubernetes cluster.',
  NODE_INTERNAL_IP_EMPTY_DESC: 'Please set the internal IP address of the node in the Petasus Kubernetes cluster.',
