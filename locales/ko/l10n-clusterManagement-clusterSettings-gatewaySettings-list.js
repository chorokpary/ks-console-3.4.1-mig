...
module.exports = {
  ...
  CLUSTER_GATEWAY_DESC:
    '클러스터에서 외부 네트워크 액세스 게이트웨이 및 서비스 관리의 구성을 설정하고 관리합니다.',
  // Cluster Gateway
  ...
  GATEWAY_TRACING_TIP:
    '<b>Tracing</b>을 활성화한 후 인그레스에 엑세스할 수 없다면, 인그레이스에 <b>nginx.ingress.kubernetes.io/service-upstream: true</b> 어노테이션을 추가하세요.',
